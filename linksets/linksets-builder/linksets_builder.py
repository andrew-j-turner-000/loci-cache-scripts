...
def harmonize_crs_albers():
    ...
    """
    run_command(["psql", "--host", "postgis", "--user", "postgres", "-c", harmonize_crs_sql])
...
def create_geometry_indexes():
    ...
    run_command(["psql", "--host", "postgis", "--user",
                 "postgres", "-c", create_geometry_indexes_sql])
...
"""
    run_command(["psql", "--host", "postgis", "--user",
                 "postgres", "-c", create_intersection_areas_sql])
...
def find_bad_meshblocks():
    ...
    """
    run_command(["psql", "--host", "postgis", "--user",
                 "postgres", "-c", find_bad_meshblocks_sql])
...
def create_classifier_views():
    ...
    """
    run_command(["psql", "--host", "postgis", "--user",
                 "postgres", "-c", create_classifier_views_sql])
