...
​
def do_overlaps():
    con = pg.connect("host=localhost port=5532 dbname=mydb user=postgres password=password")
    cur = con.cursor("cur1")
    cur.execute("""\
    ...
    FROM public."mbalbersintersectccareas_classify" as mb
    INNER JOIN public."ccalbersintersectmbareas_classify" as cc on mb.mb_code_2016 = cc.mb_code_2016 and mb.hydroid = cc.hydroid
